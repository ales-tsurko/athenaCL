...
class Test(unittest.TestCase):
    ...
    def testBasic(self):
        segment1 = HalfCosineSegment([(0.0, 0.0), (4.0, 10.0), (7.0, 5.0), (9.0, 8.0)])
        segment2 = NoInterpolationSegment(
            [(0.0, 0.0), (4.0, 10.0), (7.0, 5.0), (9.0, 8.0)]
        )
        segment3 = PowerSegment(
            [(0.0, 0.0), (4.0, 10.0), (7.0, 5.0), (9.0, 8.0)], exp=0.5
        )
        segment4 = PowerSegment(
            [(0.0, 0.0), (4.0, 10.0), (7.0, 5.0), (9.0, 8.0)], exp=2.0
        )
        segment5 = PowerSegment(
            [(0.0, 0.0), (4.0, 10.0), (7.0, 5.0), (9.0, 8.0)], exp=-0.5
        )
        segment6 = PowerSegment(
            [(0.0, 0.0), (4.0, 10.0), (7.0, 5.0), (9.0, 8.0)], exp=-2.0
        )
