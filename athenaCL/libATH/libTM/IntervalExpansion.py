...
class IntervalExpansion(baseTexture.Texture):
    ...
    def __init__(self, name=None):
        ...
        self.textPmtrNames = ['loopWithinSet', 'ornamentLibrarySelect',
            'ornamentMaxDensity', 'levelFieldMonophonic', 'levelOctaveMonophonic']
    ...
    def _ornGroup(self):
        ...
        'diatonicGroupC' : [('octotrill.0,12.b','attack','path', .5),
                                  ('octoturn.0,12,0,-12.b', 'attack', 'path', .5),
                                  ('trill.0,1.b','release','path', .5),
                                  ('fall.2,1','attack','path', .5),
                                  ('arc.0,1','attack','path', .5),],
  ...
  'trilloctoGroupA'  : [ ('trillocto.0,12.a','attack','path', .17),
                                  ('trillocto.0,12.a','release','microtone', .21),
                                  ],
                                  
        'min3GroupA'     : [ ('trillMin3.0,3.a','attack','path', .17),
                                  ('trillMin3.0,3.a','release','microtone', .21),
                                  ],
                                  
         'maj3GroupA'    : [ ('trillMaj3.0,4.a','attack','path', .17),
                                  ('trillMaj3.0,4.a','release','microtone', .21),
                                  ],
                                  
#       'neut3GroupA'    : [ ('trillNeut3.0,35.a','attack','path', .17),
#                                 ('trillNeut3.0,35.a','release','microtone', .21),]

      'trill3GroupA'     : [ ('turn.0,3,0,-3.a','attack','path', .17),
                                  ('turn.0,3,0,-3.a','attack','path', .21),
                                  ('turn.0,3,0,-3.a','attack','microtone', .21),
                                  ('trillMaj3.0,4.a','release','microtone', .21),
                                  ],
                                  
      'trillP5GroupA'     : [ ('trillP5.0,7.a','attack','path', .17),
                                    ('trillP5.0,7.a','release','microtone', .21)]  
