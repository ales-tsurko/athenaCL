...
def durToTrapezoid(
    tStart, propAbsSwitch, dur, rampUp, widthMax, rampDown, widthMin, min=0, max=1
):
...
def durToAdsr(
    tStart, propAbsSwitch, dur, attack, decay, sustain, release, susScalar, min=0, max=1
):
...
class Test(unittest.TestCase):
    ...
    def testBasic(self):
        post = durToTrapezoid(0, "proportional", 300, 10, 10, 10, 10, 0, 1)
        post = durToTrapezoid(120, "proportional", 300, 10, 20000, 10, 10, -2, 10)
        post = durToAdsr(0, "proportional", 300, 10, 10, 10, 10, 0.5, 0, 1)
        post = durToAdsr(120, "proportional", 300, 10, 200, 100, 50, 0.5, -2, 10)
        post = durToUnit(0, 300, 0.8, 0.4, 0, 1)
        post = durToUnit(120, 300, 0.01, 0.01, -2, 10)
